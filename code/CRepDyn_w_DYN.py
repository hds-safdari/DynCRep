...
class CRepDyn_w_temp:
    def __init__(self, undirected=False, initialization=0, ag=1.5,bg=2., rseed=0, inf=10000000000.0, err_max=0.000000000001, err=0.005,
                 N_real=1, tolerance=0.001, decision=3, max_iter=1000, out_inference=False,
    ...
    def _initialize(self, rng=None):
        ...
        if self.initialization == 0:
            ...
            print(theta['u'].shape,theta['w'].shape)
